'''
Introduction
I will be looking at the NYPD Complaint Data set from NYC OpenData which examines complaints made to the New York City Police Department for 2022. This includes felony, misdemeanor, and violation crimes. Crime and violence has been a major concern in New York. In this analysis, I will be performing data exploration, wrangling and present my findings.
