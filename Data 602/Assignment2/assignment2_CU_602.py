...
The print statement above returns an empty list. In the slice it references index -5 which doesn't exist.
The correct print statement is as follows:
'''
...
for day in days:
    sale = float(input(f"Enter the sale for the {day}: $"))
    sales.append(sale)

totals = sum(sales)
print(f"This is the sales for the week: ${totals}")
